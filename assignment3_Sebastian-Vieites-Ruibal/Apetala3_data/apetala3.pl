...
sub create_GFF3{
	my$ref=shift;
	my%info_hash=%$ref;
	my$outfile_local='apetala3_table_local_positions.gff';								# We introduce the name for the file where we will store the local coordinates
	my$outfile_global='apetala3_table_global_positions.gff';								# and the global coordinates.
